...
LOGFILE=/work/joliebig/cppstats/cppstats_pretty_preparation_log_`date +%Y%m%d`_$RANDOM.txt
...
while read dir; do
	...
	/home/joliebig/workspace/reverse_cpp/src/cppstats_pretty_prepare.sh $dir 2>&1 | tee -a $LOGFILE >> /dev/null
